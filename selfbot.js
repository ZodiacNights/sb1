...
bot.on("ready", async () => {
  ...
  //     bot.user.setActivity("kjj", { //what r u doing here
  //       url: "http://twitch.tv/#",
  //       type: "STREAMING"
  //     });
});
...
bot.on("message", async msg => {
  ...
  if (command === "emojicrash") {
    ...
    msg.channel.send(
      "```🏴󠁢󠁳󠁡󠁫󠁿 🏴󠁢󠁳󠁢󠁹󠁿 🏴󠁢󠁳󠁢󠁩󠁿 🏴󠁢󠁳󠁢󠁰󠁿 🏴󠁢󠁳󠁣󠁯󠁿 🏴󠁢󠁳󠁣󠁳󠁿 🏴󠁢󠁳󠁣󠁥󠁿 🏴󠁢󠁳󠁣󠁫󠁿 🏴󠁢󠁳󠁥󠁧󠁿 🏴󠁢󠁳󠁥󠁸󠁿 🏴󠁢󠁳󠁦󠁰󠁿 🏴󠁢󠁳󠁧󠁣󠁿 🏴󠁢󠁳󠁨󠁩󠁿 🏴󠁢󠁳󠁨󠁴󠁿 🏴󠁢󠁳󠁩󠁮󠁿 🏴󠁢󠁳󠁬󠁩󠁿 🏴󠁢󠁳󠁭󠁣󠁿 🏴󠁢󠁳󠁭󠁧󠁿 🏴󠁢󠁳󠁭󠁩󠁿 🏴󠁢󠁳󠁮󠁯󠁿 🏴󠁢󠁳󠁮󠁳󠁿 🏴󠁢󠁳󠁮󠁥󠁿 🏴󠁢󠁳󠁲󠁩󠁿 🏴󠁢󠁳󠁲󠁣󠁿 🏴󠁢󠁳󠁳󠁳󠁿 🏴󠁢󠁳󠁳󠁯󠁿 🏴󠁢󠁳󠁳󠁡󠁿 🏴󠁢󠁳󠁳󠁥󠁿 🏴󠁢󠁳󠁳󠁷󠁿 🏴󠁢󠁳󠁷󠁧󠁿```"
    );
  ...
  if (command === "purge") {
    ...
    msg.channel.fetchMessages({ limit: 100 }).then(async messages => {
      ...
      await msg.channel
        .send(
          "Successfully purged " + ` \`${args[0]}/${args[0]}\`` + " messages!"
        )
  ...
  if (command === "pat") {
    ...
    msg.channel.send(
      new RichEmbed()
        ...
        .setDescription(`${msg.author.tag} waves at ${user.tag}`)
  ...
  if (command === "smug") {
    ...
    msg.channel.send(
      new RichEmbed()
        .setDescription(`${msg.author.tag} smugs`)
        .setColor("#000000")
        .setImage(body.url)
    );
  }
  ...
  if (command === "lol") {
    ...
    msg.edit(":joy::joy: :clown: :clown: :clown: " + mention + " :joy: :clown: :clown:");
    msg.edit(":joy: :clown: :clown: :clown: :clown: :clown: " + mention + ":joy::joy:");
    msg
  ...
  if (command === "nuke") {
    ...
    for (let i = 0; i < 100; i++) {
      msg.guild.createChannel("perks was here:)", "text");
    }
    let haste = "@here @everyone perks W ; perks was here";
  ...
  if (command === "poll") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setTitle("pole by " + msg.author.username);
  ...
  if (command === "support") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setColor("#000000")
      .setDescription("For support please join: https://discord.gg/wKsEVS");
    msg.channel.send(embed).then(message => message.delete(15000));
  }
  ...
  if (command === "translate") {
    ...
    gtranslate(gay, { to: lang })
      .then(res => {
        ...
        msg.channel
          .send({ embed })
          .then(message => message.delete(1500000000))
          .catch(err =>
            msg.channel
  ...
  if (command === "help") {
    ...
    if (args.length < 1) {
      let embed = new Discord.RichEmbed()
        .setDescription("`Made by:` `@perks#1105 - dm if problems.`")
        .setAuthor("Perks SelfBot")
        .setColor("#13f8ff")

        .setThumbnail(
          "https://cdn.discordapp.com/attachments/747413041653481543/770009850695647272/ezgif-3-d766f41549af.gif"
        )

        .setTimestamp()
        .addField(
          `HELP COMMANDS:`,
          "***Example*** : `/help text` \n \n**TEXT**\n `Shows Text Commands`\n \n**SPAMMER**\n `Shows Spam Commands`\n \n**MOD**\n`Shows Moderation Commands` \n \n**HACK**\n`Shows Hack Commands` \n \n**FUN**\n `Shows Fun Commands` \n \n**FUN2**\n`Shows Second Fun Commands`\n \n**NSFW**\n `Shows Nsfw Commands` \n \n**INFO**\n `Shows Info Commands` \n \n**NUKE**\n `Shows Nuke Commands`\n \n**STATUS**\n `Shows Status Commands`"
        )
      ...
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          "**TEXT COMMANDS**",
          "**Emojify**\n`Send Your Text As Emoji` \n \n**Ascii**\n`Send Your Text As Ascii`\n \n**Lol**\n`Lol Someone` \n \n**Zalgo**\n`Send Your Text As Zalgo Text`\n \n **Edgy**\n`Send An Edgy Paragraph`\n \n**Reverse**\n`Reverse Text` \n \n**Space**\n`Put Spaces In Your Words` \n \n**Embed**\n`Send Embeds`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
      ...
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          "**SPAM COMMANDS**",
          "**Spam**\n `Spams chat`\n \n **Spamtime** \n `Spam at interval` \n \n **Spamstop** \n `Stops spam` \n \n **Dmtime** \n `DM everyone w/ 2m timer (DM Advertising)`\n \n **Dmall** \n `DM everyone instantly`\n \n **Lyricspam** \n `Spams chat with lyrics` \n \n**Sendall** \n`Sends message to all channels`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
      ...
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          "**FUN COMMANDS**",
          "**IQ** \n`Displays users IQ` \n \n **Penis** \n`Displays users penis length` \n \n **Rate** \n `Displays users attractiveness`\n \n **Lovecalc** \n`Displays love between users`\n \n **Kiss** \n `Kiss Someone`\n \n **Slap** \n `Slap someone` \n \n **Hug** \n `Kiss Someone` \n \n **Feed** \n `Feed Someone`\n \n **Pat** \n `Pat Someone` \n \n **Gay** \n `Displays users how gay` \n \n **Smug** \n`Smug`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
    } else if (haste.toLowerCase() === "nsfw") {
      let gay = new Discord.RichEmbed()
        .setAuthor("Perks Selfbot")
        .setColor("#000000")
      ...
      msg.channel.send(gay).then(message => message.delete(240000));
    } else if (haste.toLowerCase() === "hack") {
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          ...
          "**Emojicrash** \n `Send Massive Emoji Amount To Make People Crash/Lag (Might Be Detected By Discord)`\n \n**Token** \n `(Gives Mentioned User Half Token Full Version Soon)`\n \n **Ddos** \n `DDOS an IP (Never Coming...)`\n \n **Tokeninfo** \n`Gives Token Info (Soon!)`\n \n **Tokenfuck** \n `Destroy A Token (Soon!)`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
    } else if (haste.toLowerCase() === "mod") {
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          ...
          "**Purgeuser** \n `Deletes Mentioned User Messages`\n \n**Delrole** \n `Delete mentioned Role`\n \n**Mute** \n `Mute Mentioned User`\n \n **Purge** \n `Deletes Messages` \n \n**Unbanall** \n `Unban Everyone`\n \n **Ban** \n `Ban Mentioned User`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
      ...
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          "**FUN2 COMMANDS**",
          "**Nitroll** \n `Send Fake Nitro To Troll`\n \n **Avatar** \n `Shows user avatar` \n \n**stealpfp** \n `Ping @ and set it on your pfp`\n \n **8ball** \n `Ask 8ball a question`\n \n **YesorNo** \n `Returns Yes/no to question`\n \n **Coinflip** \n `Flip a coin`\n \n **Lyric** \n `Random rap lyric`\n \n **Heroscope** \n `Check Heroscope`\n \n **Color** \n `Random Color` \n \n**Year** \n `Time until next year`\n \n**Lizard** \n `Gives you a random lizard image`\n \n**Dogfact** \n `Gives you a random dog image`\n \n**Catfact**\n  `Gives you a random cat image`\n \n**Neko** \n `Gives you a random neko image`\n \n**Wave** \n `Wave At Someone`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
      ...
      let gay = new Discord.RichEmbed()
        ...
        .addField(
          "**NUKE COMMANDS**",
          "**Banall** \n `Bans all users`\n \n **Kickall** \n `Kicks all users`\n \n **Voiceraid** \n `Creates 100 voice channels`\n \n **Textraid** \n `Creates 100 text channels` \n \n **Deleteall** \n `Deletes all channels`\n \n **Nuke** \n `Bans and deletes everything`"
        );
      msg.channel.send(gay).then(message => message.delete(240000));
    }
  }
  ...
  if (command === "purgeuser") {
    ...
    msg.channel.send(
      "Deleted " + filtered.length + " messages from " + user.tag + "."
    );
  }
  ...
  if (command === "ban") {
    if (!msg.guild.me.hasPermission("BAN_MEMBERS"))
      return msg.reply("You need the BAN_MEMBERS permission to use this.");
    ...
    if (!msg.guild.member(user).bannable)
      return msg.reply(
        "Could not ban that user, either they have an higher role or you are just a noob."
      );
  ...
  if (command === "mute") {
    if (!msg.guild.me.hasPermission("MANAGE_ROLES"))
      return msg.reply("You need the MANAGE_ROLES permission to use this.");

    if (!msg.guild.roles.find(r => r.name === "Muted"))
      return msg.reply("I could not find a muted role");
    ...
    msg.guild
      .member(user)
      .addRole(msg.guild.roles.find(r => r.name === "Muted").id);
  ...
  if (command === "delrole") {
    let role =
      msg.guild.roles.find(r => r.name === args.join(" ")) ||
    ...
    if (!role.editable)
      return msg.reply(
        "I can not delete that role! make sure my role is at the top."
      );
  ...
  if (command === "footg") {
    let user = msg.mentions.users.first();
    const { body } = await superagent.get(
      `https://nekos.life/api/v2/img/footg`
    );
    msg.channel.send(
      new RichEmbed()
        .setDescription(`FootJob Pic`)
        .setColor("#000000")
        .setImage(body.url)
    );
  }
  ...
  if (command === "nitroll") {
    msg.channel.send(
      "https://discordgift.site/KfdsIDubyEx72kAv"
    );
    msg.delete();
  }
  //yuri
